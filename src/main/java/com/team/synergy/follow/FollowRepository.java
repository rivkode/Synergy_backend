...
public interface FollowRepository extends JpaRepository<Follow, Long> {
    ...
    @Query(value = "SELECT follower_id FROM follow WHERE following_id = :id", nativeQuery = true)
    List<String> findFollowerIdsByFollowingId(@Param("id") String id);
    ...
    @Query(value = "SELECT * FROM follow WHERE follow_id = :followId for update", nativeQuery = true)
    Optional<Follow> findById(@Param("followId") Long id);
}
